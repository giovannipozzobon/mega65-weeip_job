...
cd obj
ln6502 --target=mega65 --core=45gs02 --cstack-size=0x800 --heap-size=4000  --output-format=prg mega65-terminal.scm memory.o random.o debug.o hal.o time.o targets.o arp.o checksum.o dhcp.o dns.o eth.o nwk.o socket.o task.o terminal.o -o terminal.prg
cd ..
